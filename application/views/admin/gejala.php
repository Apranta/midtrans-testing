                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row->nama ?></td>
                                                <td align="center">
                                                <button class="btn btn-danger btn-xs" onclick="_delete(<?= $row->id_gejala ?>)"><i class="glyphicon glyphicon-trash"></i></button>

                                                <button class="btn btn-primary btn-xs" onclick="_edit(<?= $row->id_gejala ?>)" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button>
                                                </td>
                                            </tr>
                                            <?php $i++; endforeach; ?>
                                        </tbody>
            ...
            <script>
                ...
                function _delete(id) {
                    ...
                    $.ajax({
                            ...
                            success: function() {
                                window.location = "<?= base_url('admin/gejala') ?>";
                            }
                        });
                }
